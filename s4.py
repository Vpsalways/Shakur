...
bot = telebot.TeleBot('7245792065:AAFPzoo6cOHKPY_ANS5_PiIB667LFHl4ohU')

# @S4 OFFICIAL GRP # Admin user IDs
admin_id = ["811290532","717394708","5214410081"]
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "PEHELE KHAREEDO FIR AAPKA D DOS CHALEGA"
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "PEHELE KHAREEDO FIR AAPKA D DOS CHALEGA𝙀."
        bot.reply_to(message, response)
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < 5:
                response = "💢G͢A͢N͢D͢ F͢A͢T͢ G͢Y͢A͢ H͢ 💢 \nT͢H͢O͢D͢A͢ S͢H͢I͢L͢N͢E͢ D͢O͢ B͢A͢S͢ 2͢ M͢I͢N͢U͢T͢E͢ R͢U͢K͢O͢ W͢A͢P͢A͢S͢ A͢A͢Y͢A͢"
                bot.reply_to(message, response)
                return
        ...
        if len(command) == 4:  # @S4 OFFICIAL GRP # Updated to accept target, time, and port
            ...
            if time > 599:
                ...
                response = f"🛑𝐀𝐓𝐓𝐀𝐂𝐊 𝐖𝐀𝐒 𝐅𝐈𝐍𝐈𝐒𝐇 𝐔𝐏 𝐏𝐋𝐄𝐀𝐒𝐄 𝐒𝐄𝐍𝐃 𝐀𝐍𝐎𝐓𝐇𝐄𝐑 𝐀𝐓𝐓𝐀𝐂𝐊"
        else:
            response = "✅ČĤĂĹ МĂĂŔ ŃĂ✅\n\n/̳b̳g̳m̳i̳ ̳<̳t̳a̳r̳g̳e̳t̳>̳ ̳<̳p̳o̳r̳t̳>̳ ̳<̳t̳i̳m̳e̳>\nT̶r̶y̶ ̶t̶o̶ ̶2̶4̶0̶ ̶s̶e̶c̶o̶n̶d̶s̶ \n."  # @S4 OFFICIAL GRP # Updated command syntax
    else:
        response = " PEHELE KHAREEDO FIR AAPKA D DOS CHALEGA ."
...
S‌A‌H‌A‌Y‌A‌T‌A‌ K‌R‌E‌N‌G‌E👋

🛑 /bgmi --> ɪꜱꜱᴇ ᴛᴜᴍʜᴀʀᴀ ɢᴀᴍᴇ ᴋʜᴛᴀᴍ ʜᴏ ᴊᴀʏᴇɢᴀ
🛑 /add --> ᴏɴʟʏ ᴏᴡɴᴇʀ ᴄᴀɴ ᴘᴇʀꜰᴏʀᴍ ᴛʜɪꜱ
🛑 /remove --> ᴋɪꜱɪ ɢᴀɴɢ ᴍᴇᴍʙᴇʀ ᴋᴏ ʜᴀᴛᴀᴏ
🛑 /mylogs --> ʏᴏᴜʀ ʜɪꜱᴛᴏʀʏ
🛑 /id  --> ᴛᴇʟᴇɢʀᴀᴍ ɪᴅ ꜱᴇɴᴅ ᴋᴀʀᴏ
🛑 /start --> ʀᴇꜱᴛᴀʀᴛ ʙᴏᴛ
🛑 /plan --> ᴘᴜʀᴄʜᴀꜱᴇ ᴘʀᴇᴍɪᴜᴍ ʙᴏᴛ
🛑 /rules --> ʀᴜʟᴇꜱ ʙᴏᴏᴋ 📚
🛑 /admincmd --> ꜱɪʀꜰ ᴏᴡɴᴇʀ ɪꜱᴇ ᴜꜱᴇ ᴋᴀʀ ꜱᴀᴋᴛᴀ ʜᴀɪ
🛑 /logs  --> ʙᴏᴛ ᴋᴀ ʜɪꜱᴛᴏʀʏ ᴀʟʟ ᴜꜱᴇʀꜱ
🛑 /allusers --> ꜱᴀʙʜɪ ᴜꜱᴇʀꜱ ᴋɪ ʟɪꜱᴛ
...
HACKINGANDROID. 𝐌𝐄 𝐊𝐎𝐈 𝐑𝐔𝐋𝐄𝐒 𝐍𝐇𝐈 𝐇𝐎𝐓𝐀 𝐁𝐔𝐓 𝐏𝐑𝐎𝐌𝐎𝐓𝐈𝐎𝐍 𝐊𝐈𝐘𝐀 𝐘𝐀 𝐅𝐈𝐑 𝐊𝐈𝐒𝐈 𝙆𝙊 𝐃𝐌 𝐊𝐑𝐊𝐄 𝐒𝐂𝐀𝐌 𝐊𝐈𝐘𝐀 𝐓𝐎 𝐆𝐀𝐍𝐃 𝐌𝐀𝐀𝐑 𝐋𝐈𝐘𝐀 𝐉𝐀𝐘𝐄𝐆𝐀 𝐎𝐊😡'''
    bot.reply_to(message, response)
